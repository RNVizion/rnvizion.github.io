...
def main() -> int:
    ...
    # Say what this file is, every run. up.py has held three different scripts
    # in two days; "I ran it and nothing happened" is unanswerable when the
    # name does not tell you which one you ran.
    print(f"{D}link_demo.py -- adds the Demos nav link and the walkthrough URL "
          f"to resume/index.html{N}")
